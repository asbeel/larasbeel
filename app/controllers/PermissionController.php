...
class PermissionController extends BaseController 
{
    ...
    */
    public function getIndex()
    {
        ...
        if(Request::ajax())
        {
            $html = View::make('permission.list-permissions', array('permissions' => $permissions))->render();
            
            return Response::json(array('html' => $html));
        }

        $this->layout = View::make('permission.index-permission', array('permissions' => $permissions));
        $this->layout->title = "Permissions list";
        $this->layout->breadcrumb = Config::get('breadcrumbs.permissions');
    }
    ...
    {
        $this->layout = View::make('permission.new-permission');
        $this->layout->title = "New permission";
        $this->layout->breadcrumb = Config::get('breadcrumbs.create_permission');
    }
    ...
    public function postCreate()
    {
        try
        {
            $validator = Validator::make(
                Input::all(),
                Config::get('rules.permissions.create')
            );
        ...
        catch (\Models\Permissions\NameRequiredException $e) {}
        catch (\Models\Permissions\ValueRequiredException $e) {}
        catch (\Models\Permissions\PermissionExistsException $e)
        {
    ...
    */
    public function getShow($permissionId)
    {
        try
        {
            ...
            $this->layout = View::make('permission.show-permission', array(
        ...
        {
            $this->layout = View::make('dashboard.error', array('message' => 'Sorry, permission not found ! '));
        }
    }
