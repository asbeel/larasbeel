...
class UserController extends BaseController 
{
    ...
    */
    public function getIndex()
    {
        ...
        if(Request::ajax())
        {
            $html = View::make('user.list-users', array('datas' => $datas))->render();
            
            return Response::json(array('html' => $html));
        }
        
        $this->layout = View::make('user.index-user', array('datas' => $datas));
        $this->layout->title = "Users list";
        $this->layout->breadcrumb = Config::get('breadcrumbs.users');
    }
    ...
    */
    public function getCreate()
    {
        ...
        $this->layout = View::make('user.new-user', array('groups' => $groups, 'permissions' => $permissions));
        $this->layout->title = "New user";
        $this->layout->breadcrumb = Config::get('breadcrumbs.create_user');
    }
    ...
    */
    public function getShow($userId)
    {
        try
        {
            ...
            $this->layout = View::make('user.show-user', array(
                'user' => $user,
                'throttle' => $throttle,
                'groups' => $groups,
        ...
        {
            $this->layout = View::make('dashboard.error', array('message' => 'Sorry, user not found ! '));
        }
    }
