...
@section('content')
<script src="{{ asset('assets/js/dashboard/permission.js') }}"></script>
@include('layouts.dashboard.confirmation-modal',  array('title' => "Confirm delete", 'content' => 'Are you sure you want to delete these items ?', 'type' => 'delete-permission'))
        ...
        <div class="col-lg-10">
            <section class="module">
                ...
                <div class="module-body ajax-content">
                    @include('permission.list-permissions')
                </div>
            </section>
        </div>
        <div class="col-lg-2">
